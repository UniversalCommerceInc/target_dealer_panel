...
import { login } from '../slices/userSlice'; // Import Redux login action
...
<Toaster
  ...
  reverseOrder={false}
/>
      <div className="rounded-sm min-h-screen pb-2 border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      ...
      <svg
                ...
                <div className="mb-5">
                  {loading?
                  <button className=" relative w-full h-14 cursor-pointer rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90">
